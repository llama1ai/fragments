...
export const fragmentSchema = z.object({
  ...
  file_path: z
    .string()
    .optional()
    .describe('Relative path to the file, including the file name. Required when "code" is a string; ignored when "code" is an array.'),
  code: z
    .union([
      z.string(),
      z.array(
    ...
    .describe('Code generated by the fragment. If multiple files are needed, return an array of { file_path, file_content } with EVERY required file; otherwise return a single string and provide "file_path". Only runnable code is allowed.'),
